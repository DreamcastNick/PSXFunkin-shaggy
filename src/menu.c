...
static const char *funny_messages[][2] = {
	...
	{"FUNKIN", "FOREVER"},
	{"WHAT THE HELL", "SHAGGY X MATT PSX"},
	...
	{"SR PEREZ", "FOREVER"},
	{"NO SIX OR NINE KEY", "CRY ABOUT IT"},
	{"OK OKAY", "WATCH THIS"},
	...
	{"PSXFUNKIN BY CUCKYDEV", "WHATS IT TO YA"},
			...
			else
			{
				...
				//Fallthrough
					...
					case 1:
						...
						menu.font_bold.draw(&menu.font_bold, "SR PEREZ", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						break;
				...
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "SHAGGY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "FIRST ENCOUNTER", {"WHERE ARE YOU", "ERUPTION", "KAIO KEN"}},
				{"2", StageId_2_1, "THE REMATCH", {"WHATS NEW", "BLAST", "SUPER SAIYAN"}},
				{"3", StageId_3_1, "ULTIMATE DESTRUCTION", {"GOD EATER", NULL, NULL}},
				{"4", StageId_4_1, "CRUEL REVELATION", {"POWER LINK", "REVENGE", "FINAL DESTINATION"}},
				{"5", StageId_5_1, "BONUS MATCH", {"SOOTHING POWER", "THUNDERSTORM", "DISSASEMBLER"}},
				{"6", StageId_6_1, "SPECIAL KOMBAT", {"ASTRAL CALAMITY", NULL, NULL}},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_2, "   VS SHAGGY PORT", false},				
				...
				{StageId_Clwn_1, "SR PEREZ", false},
				{StageId_Clwn_1, "   ORGINAL PROGRAMMER ", false},
				{StageId_Clwn_1, "MORO", false},
				{StageId_Clwn_1, "   SPRITE ARTIST ", false},
				{StageId_Clwn_1, "SANDPLANET", false},
				{StageId_Clwn_1, "   CO-CHARTER ", false},
				{StageId_Clwn_1, "SARUKY", false},
				{StageId_Clwn_1, "   COMPOSER ", false},
				{StageId_Clwn_1, "JOAN ATLAS", false},
				{StageId_Clwn_1, "   COMPOSER ", false},
				{StageId_Clwn_1, "SULAYRE", false},
				{StageId_Clwn_1, "   MATT SPRITES ", false},
				{StageId_Clwn_1, "THEONLYVOLUME", false},
				{StageId_Clwn_1, "   COMPOSER ", false},
				{StageId_Clwn_1, "HAYLEY CONTROL", false},
				{StageId_Clwn_1, "   BOXING RING ART ", false},
