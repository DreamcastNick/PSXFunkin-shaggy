...
//Henchmen functions
void Week9_Henchmen_SetFrame(void *user, u8 frame)
{
	Back_Week9 *this = (Back_Week9*)user;
...
void Week9_Henchmen_Draw(Back_Week9 *this, fixed_t x, fixed_t y)
{
	//Draw character
...
void Back_Week9_DrawMD(StageBack *back)
{
	Back_Week9 *this = (Back_Week9*)back;
...
void Back_Week9_DrawBG(StageBack *back)
{
	...
	Animatable_Animate(&this->hench_animatable, (void*)this, Week9_Henchmen_SetFrame);
	
	Week9_Henchmen_Draw(this, FIXED_DEC(-50,1) - fx, FIXED_DEC(30,1) - fy);
	Week9_Henchmen_Draw(this,  FIXED_DEC(50,1) - fx, FIXED_DEC(30,1) - fy);
	Week9_Henchmen_Draw(this, FIXED_DEC(150,1) - fx, FIXED_DEC(30,1) - fy);
	Week9_Henchmen_Draw(this, FIXED_DEC(250,1) - fx, FIXED_DEC(30,1) - fy);
...
StageBack *Back_Week9_New(void)
{
	...
	this->back.draw_md = Back_Week9_DrawMD;
	...
	this->arc_hench = IO_Read("\\WEEK9\\HENCH.ARC;1");
